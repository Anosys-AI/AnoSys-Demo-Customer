        ...
        <footer style={{
            ...
            <div className="container">
                <div style={{
                    ...
                    <div style={{ gridColumn: 'span 2' }}>
                        <div className="logo" style={{
                            ...
                            <Home size={28} />
                            <span>APOGEE RESIDENCES</span>
                        </div>
                        <p style={{ color: 'var(--text-muted)', maxWidth: '300px' }}>
                            Apogee Residences is the global authority in luxury real estate, providing unparalleled service to the world's most discerning clients.
                        </p>
                    </div>
                    <div>
                ...
                <div style={{
                    ...
                    <p>© 2026 Apogee Residences. All rights reserved.</p>
